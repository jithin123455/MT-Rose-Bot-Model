...
*ഞാൻ* [ഇദ്ദേഹം](https://t.me/BANDU_OF_tg) *നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ്.*

*എന്നെപ്പോലെ ഒരു അഡ്മിൻ ബോട്ടിനെ ഉണ്ടാക്കുവാൻ [UPDATES CHANNEL ](https://t.me/kalyaniv1) JOIN ചെയ്യുക 
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="⭕️ Command Help ⭕️", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="📢Updates", url="t.me/kalyaniv1"), InlineKeyboardButton(text="GITHUB", url="https://github.com/jithin123455")],
